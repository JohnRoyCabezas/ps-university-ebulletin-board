      ...
      <div className="relative flex flex-col justify-center h-screen items-center">
        <div className="w-full p-8 m-auto bg-custom-gray rounded-md shadow-md lg:max-w-xl">
          ...
          <form className="mt-6" onSubmit={handleSubmit}>
            ...
            <div className="mt-10">
              <button
                className={`w-full px-2 py-2 tracking-wide transition-colors duration-200 transform ${!email || !password ? "bg-gray-300 text-gray-400" : "bg-regal-blue text-white shadow-lg shadow-regal-blue-500/50"} rounded-md focus:outline-none focus:bg-blue-900`}
